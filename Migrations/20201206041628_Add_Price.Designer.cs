...
namespace ASPNetCore5Demo.Migrations
{
    ...
    [Migration("20201206041628_Add_Price")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ASPNetCore5Demo.Models.Models.Course", b =>
                {
            ...
            modelBuilder.Entity("ASPNetCore5Demo.Models.Models.CourseInstructor", b =>
                {
                    b.Property<int>("CourseId")
                        .HasColumnType("int")
                        .HasColumnName("CourseID");
            ...
            modelBuilder.Entity("ASPNetCore5Demo.Models.Models.Department", b =>
                {
                    b.Property<int>("DepartmentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ASPNetCore5Demo.Models.Models.Enrollment", b =>
                {
            ...
            modelBuilder.Entity("ASPNetCore5Demo.Models.Models.OfficeAssignment", b =>
                {
                    b.Property<int>("InstructorId")
                        .HasColumnType("int")
                        .HasColumnName("InstructorID");
            ...
            modelBuilder.Entity("ASPNetCore5Demo.Models.Models.Person", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ASPNetCore5Demo.Models.Models.VwCourseStudentCount", b =>
                {
                    b.Property<int>("CourseId")
                        .HasColumnType("int")
                        .HasColumnName("CourseID");
            ...
            modelBuilder.Entity("ASPNetCore5Demo.Models.Models.VwCourseStudents", b =>
                {
                    b.Property<int>("CourseId")
                        .HasColumnType("int")
                        .HasColumnName("CourseID");
            ...
            modelBuilder.Entity("ASPNetCore5Demo.Models.Models.VwDepartmentCourseCount", b =>
                {
            ...
            modelBuilder.Entity("ASPNetCore5Demo.Models.Models.Course", b =>
                {
                    b.HasOne("ASPNetCore5Demo.Models.Models.Department", "Department")
                        .WithMany("Course")
            ...
            modelBuilder.Entity("ASPNetCore5Demo.Models.Models.CourseInstructor", b =>
                {
                    b.HasOne("ASPNetCore5Demo.Models.Models.Course", "Course")
                    ...
                    b.HasOne("ASPNetCore5Demo.Models.Models.Person", "Instructor")
                        .WithMany("CourseInstructor")
            ...
            modelBuilder.Entity("ASPNetCore5Demo.Models.Models.Enrollment", b =>
                {
                    ...
                    b.HasOne("ASPNetCore5Demo.Models.Models.Person", "Student")
                        .WithMany("Enrollment")
            ...
            modelBuilder.Entity("ASPNetCore5Demo.Models.Models.OfficeAssignment", b =>
                {
                    b.HasOne("ASPNetCore5Demo.Models.Models.Person", "Instructor")
                        ...
                        .HasForeignKey("ASPNetCore5Demo.Models.Models.OfficeAssignment", "InstructorId")
